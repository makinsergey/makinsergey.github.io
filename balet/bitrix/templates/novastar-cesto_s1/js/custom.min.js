...
$(".gallary a.fancyimage").fancybox();
	$('body').on("click",'.modal_close, span.main-user-consent-request-popup-button',function(){
$('div.main-user-consent-request-popup:nth-child(n+2)').remove();
});
...
$(window).scroll(function(){
    ...
    var touch = $('.portfolio-all');
    var menu = $('.hidden-block');
 
    $(touch).on('click', function(e) {
        e.preventDefault();
$(this).text(menu.is(':visible') ? 'Смотреть всё' : 'Скрыть ');
		$(this).parents('.proect').find('.hidden-block').slideToggle();
    });
});